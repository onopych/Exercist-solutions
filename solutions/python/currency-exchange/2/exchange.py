...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    spread /= 100
    real_exchange_rate = exchange_rate + (exchange_rate * spread)
    all_budget_in_foreign_currency = budget / real_exchange_rate
    exchangeable_value = all_budget_in_foreign_currency - (all_budget_in_foreign_currency % denomination)
